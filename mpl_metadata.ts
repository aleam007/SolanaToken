...
import {Collection, CreateMetadataAccountV3InstructionAccounts, CreateMetadataAccountV3InstructionDataArgs, Creator, 
    MPL_TOKEN_METADATA_PROGRAM_ID, UpdateMetadataAccountV2InstructionAccounts, UpdateMetadataAccountV2InstructionData, Uses, createMetadataAccountV3, updateMetadataAccountV2, findMetadataPda} from "@metaplex-foundation/mpl-token-metadata";
...
async function main(){
    console.log("Create Token For Final Project");
    const myKeypair = loadWalletKey("AndypMajuZHk6qBJkGikVdRpVQXxB3H9bruKTpbVSXR.json");
    const mint = new web3.PublicKey("LDT2Y1G63cwWTzBcYoG9uGR9Uqhbh36T1Wtos9BF5eQ");
